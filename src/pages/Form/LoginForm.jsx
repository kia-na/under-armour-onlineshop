  ...
  return (
    <div className="h-screen bg-gray-600 w-full flex justify-center items-center relative">
      <form
        ...
        className="bg-white w-11/12 h-3/8 lg:w-2/6 lg:h-2/5 sm:h-3/6 flex flex-col gap-3 justify-between rounded-lg px-3 py-5 text-center sm:w-4/6 md:w-3/6 lg:px-[5%]"
      >
        ...
        {formErr && <div className="text-red-400">{formErr}</div>}
        <button
          type="submit"
          className="py-1 border-2 rounded-md text-white bg-gray-800 cursor-pointer sm:py-3 sm:text-lg"
        >
          SIGN IN
        </button>
